...
- **Outfits** — list, create/edit from wardrobe pieces, mark as worn, delete, **share look** (system share sheet + image)
- **Today** — weather-aware “What should I wear?” stylist (clearer reasons, neglected-piece boost, better empty guidance); **Tweak look** before wear/save + wear history
